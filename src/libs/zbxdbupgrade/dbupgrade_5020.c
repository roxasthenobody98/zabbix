...
static int	DBpatch_5020001(void)
{
	DB_RESULT	result;
	int		ret;
...
static int	DBpatch_5020002(void)
{
	DB_RESULT	result;
	int		ret;
	const char	*fields[] = {"subject", "message"};
...
static int	DBpatch_5020003(void)
{
...
DBPATCH_ADD(5020001, 0, 0)
DBPATCH_ADD(5020002, 0, 0)
DBPATCH_ADD(5020003, 0, 0)
