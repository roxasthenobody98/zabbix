...
var (
	...
	paramTLSWallet  = metric.NewConnParam("TLSWallet", "TLS wallet file path.").WithDefault("")
)

var metrics = metric.MetricSet{
	keyASMDiskGroups: metric.New("Returns ASM disk groups statistics.",
		[]*metric.Param{paramURI, paramUsername, paramPassword, paramService, paramTLSConnect, paramTLSWallet}, false),
	...
	keyCustomQuery: metric.New("Returns result of a custom query.",
		[]*metric.Param{paramURI, paramUsername, paramPassword, paramService, paramTLSConnect, paramTLSWallet, metric.NewParam("QueryName", "Name of a custom query "+
	...
	keySessions: metric.New("Returns sessions statistics.",
		[]*metric.Param{paramURI, paramUsername, paramPassword, paramService, paramTLSConnect, paramTLSWallet, metric.NewParam(
	...
	keySysMetrics: metric.New("Returns a set of system metric values.",
		[]*metric.Param{paramURI, paramUsername, paramPassword, paramService, paramTLSConnect, paramTLSWallet,
	...
	keyUser: metric.New("Returns user information.",
		[]*metric.Param{paramURI, paramUsername, paramPassword, paramService, paramTLSConnect, paramTLSWallet,
			metric.NewParam("Username", "Username for which the information is needed.")}, false),
}
